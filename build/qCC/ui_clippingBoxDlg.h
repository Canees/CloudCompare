...
public:
    ...
    void retranslateUi(QDialog *ClippingBoxDlg)
    {
        ...
        contourGroupBox->setTitle(QCoreApplication::translate("ClippingBoxDlg", "Envelope/Contour", nullptr));
#if QT_CONFIG(tooltip)
        extractContourToolButton->setToolTip(QCoreApplication::translate("ClippingBoxDlg", "Extracts the envelope (concave hull) or contours as polylines", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        extractContourToolButton->setStatusTip(QCoreApplication::translate("ClippingBoxDlg", "Extracts the envelope (concave hull) or contours as polylines", nullptr));
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(tooltip)
        removeLastContourToolButton->setToolTip(QCoreApplication::translate("ClippingBoxDlg", "Removes the last extracted envelope or contours", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        removeLastContourToolButton->setStatusTip(QCoreApplication::translate("ClippingBoxDlg", "Removes the last extracted envelope or contours", nullptr));
#endif // QT_CONFIG(statustip)
        slicesGroupBox->setTitle(QCoreApplication::translate("ClippingBoxDlg", "Slices", nullptr));
#if QT_CONFIG(tooltip)
        exportButton->setToolTip(QCoreApplication::translate("ClippingBoxDlg", "Export selection as new entities", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        exportButton->setStatusTip(QCoreApplication::translate("ClippingBoxDlg", "Export selection as new entities", nullptr));
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(tooltip)
        exportMultButton->setToolTip(QCoreApplication::translate("ClippingBoxDlg", "Export multiple slices, envelopes or contours\n"
"by repeating the process along one or several dimensions", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
