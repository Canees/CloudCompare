...
public:
    ...
    {
        SorFilterDialog->setWindowTitle(QCoreApplication::translate("SorFilterDialog", "Statistical Outlier Removal", nullptr));
        label->setText(QCoreApplication::translate("SorFilterDialog", "Number of points to use for\n"
"mean distance estimation", nullptr));
#if QT_CONFIG(tooltip)
        knnSpinBox->setToolTip(QCoreApplication::translate("SorFilterDialog", "Number of neighbors (used to compute the average distance of each point to its neighbors)", nullptr));
#endif // QT_CONFIG(tooltip)
        label_4->setText(QCoreApplication::translate("SorFilterDialog", "Standard deviation\n"
"multiplier threshold (nSigma)", nullptr));
        label_2->setText(QCoreApplication::translate("SorFilterDialog", "(max distance = average distance + nSigma * std. dev.)", nullptr));
    } // retranslateUi
