...
public:
    ...
    void setupUi(QDialog *CamSensorProjectDialog)
    {
        ...
        gridLayout_2->addWidget(posZEdit, 3, 5, 1, 1);
        ...
        gridLayout_2->addWidget(posXEdit, 1, 5, 1, 1);
        ...
        gridLayout_2->addItem(spacerItem, 5, 3, 1, 1);
        ...
        gridLayout_2->addWidget(posYEdit, 2, 5, 1, 1);
        ...
        inWorldCSCheckBox = new QCheckBox(tabOrientation);
        inWorldCSCheckBox->setObjectName(QString::fromUtf8("inWorldCSCheckBox"));
        inWorldCSCheckBox->setChecked(true);

        gridLayout_2->addWidget(inWorldCSCheckBox, 4, 5, 1, 1);
        ...
        QWidget::setTabOrder(propertiesTabWidget, x1rot);
...
#if QT_CONFIG(tooltip)
        inWorldCSCheckBox->setToolTip(QCoreApplication::translate("CamSensorProjectDialog", "center is expressed in the world coordinate system", nullptr));
#endif // QT_CONFIG(tooltip)
        inWorldCSCheckBox->setText(QCoreApplication::translate("CamSensorProjectDialog", "in world C.S.", nullptr));
