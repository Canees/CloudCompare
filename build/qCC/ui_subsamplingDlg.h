...
public:
    ...
    void setupUi(QDialog *SubsamplingDialog)
    {
        ...
        SubsamplingDialog->resize(350, 310);
        ...
        samplingMethodComboBox = new QComboBox(mainParamGroupBox);
        samplingMethodComboBox->setObjectName(QString::fromUtf8("samplingMethodComboBox"));

        hboxLayout->addWidget(samplingMethodComboBox);
        ...
        valueDoubleSpinBox = new QDoubleSpinBox(mainParamGroupBox);
        valueDoubleSpinBox->setObjectName(QString::fromUtf8("valueDoubleSpinBox"));
        valueDoubleSpinBox->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        valueDoubleSpinBox->setDecimals(4);
        valueDoubleSpinBox->setMaximum(100.000000000000000);
        valueDoubleSpinBox->setSingleStep(0.010000000000000);
        valueDoubleSpinBox->setValue(100.000000000000000);
        ...
        QWidget::setTabOrder(samplingMethodComboBox, slider);
        ...
        QObject::connect(sfGroupBox, SIGNAL(toggled(bool)), valueDoubleSpinBox, SLOT(setDisabled(bool)));
    ...
    void retranslateUi(QDialog *SubsamplingDialog)
    {
        ...
        valueLabel->setText(QCoreApplication::translate("SubsamplingDialog", "type of value:", nullptr));
#if QT_CONFIG(tooltip)
