...
public:
    ...
    QLabel *label_12;
    QLabel *label_13;
    QDoubleSpinBox *groundMaxEdgeLengthDoubleSpinBox;
    ...
    QLabel *label_5;
    QLabel *label_11;
    QDoubleSpinBox *ceilMaxEdgeLengthDoubleSpinBox;
    ...
    void setupUi(QDialog *VolumeCalcDialog)
    {
        ...
        formLayout_2->setWidget(3, QFormLayout::FieldRole, groundEmptyValueDoubleSpinBox);

        label_12 = new QLabel(groundGroupBox);
        label_12->setObjectName(QString::fromUtf8("label_12"));

        formLayout_2->setWidget(3, QFormLayout::LabelRole, label_12);

        label_13 = new QLabel(groundGroupBox);
        label_13->setObjectName(QString::fromUtf8("label_13"));

        formLayout_2->setWidget(5, QFormLayout::LabelRole, label_13);

        groundMaxEdgeLengthDoubleSpinBox = new QDoubleSpinBox(groundGroupBox);
        groundMaxEdgeLengthDoubleSpinBox->setObjectName(QString::fromUtf8("groundMaxEdgeLengthDoubleSpinBox"));
        groundMaxEdgeLengthDoubleSpinBox->setEnabled(false);
        groundMaxEdgeLengthDoubleSpinBox->setDecimals(6);
        groundMaxEdgeLengthDoubleSpinBox->setMinimum(-999999999.000000000000000);
        groundMaxEdgeLengthDoubleSpinBox->setMaximum(999999999.000000000000000);

        formLayout_2->setWidget(5, QFormLayout::FieldRole, groundMaxEdgeLengthDoubleSpinBox);
        ...
        formLayout_2->setWidget(2, QFormLayout::FieldRole, fillGroundEmptyCellsComboBox);
        ...
        label_5 = new QLabel(ceilGroupBox);
        label_5->setObjectName(QString::fromUtf8("label_5"));

        formLayout_3->setWidget(2, QFormLayout::LabelRole, label_5);

        label_11 = new QLabel(ceilGroupBox);
        label_11->setObjectName(QString::fromUtf8("label_11"));

        formLayout_3->setWidget(3, QFormLayout::LabelRole, label_11);

        ceilMaxEdgeLengthDoubleSpinBox = new QDoubleSpinBox(ceilGroupBox);
        ceilMaxEdgeLengthDoubleSpinBox->setObjectName(QString::fromUtf8("ceilMaxEdgeLengthDoubleSpinBox"));
        ceilMaxEdgeLengthDoubleSpinBox->setEnabled(false);
        ceilMaxEdgeLengthDoubleSpinBox->setDecimals(6);
        ceilMaxEdgeLengthDoubleSpinBox->setMinimum(-999999999.000000000000000);
        ceilMaxEdgeLengthDoubleSpinBox->setMaximum(999999999.000000000000000);

        formLayout_3->setWidget(3, QFormLayout::FieldRole, ceilMaxEdgeLengthDoubleSpinBox);
    ...
    void retranslateUi(QDialog *VolumeCalcDialog)
    {
        ...
        label_12->setText(QCoreApplication::translate("VolumeCalcDialog", "Default height", nullptr));
        label_13->setText(QCoreApplication::translate("VolumeCalcDialog", "Max edge length", nullptr));
#if QT_CONFIG(tooltip)
        groundMaxEdgeLengthDoubleSpinBox->setToolTip(QCoreApplication::translate("VolumeCalcDialog", "Max edge length for interpolation/triangulation\n"
"(ignored if zero)", nullptr));
#endif // QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        label_5->setText(QCoreApplication::translate("VolumeCalcDialog", "Default height", nullptr));
        label_11->setText(QCoreApplication::translate("VolumeCalcDialog", "Max edge length", nullptr));
#if QT_CONFIG(tooltip)
        ceilMaxEdgeLengthDoubleSpinBox->setToolTip(QCoreApplication::translate("VolumeCalcDialog", "Max edge length for interpolation/triangulation\n"
"(ignored if zero)", nullptr));
#endif // QT_CONFIG(tooltip)
