...
public:
    ...
    void setupUi(QDialog *ComparisonDialog)
    {
        ...
        ComparisonDialog->resize(450, 400);
        ...
        signedDistFrame->setFrameShape(QFrame::StyledPanel);
        signedDistFrame->setFrameShadow(QFrame::Raised);
        horizontalLayout_3 = new QHBoxLayout(signedDistFrame);
        ...
        horizontalLayout_3->addWidget(flipNormalsCheckBox);

        robustCheckBox = new QCheckBox(signedDistFrame);
        robustCheckBox->setObjectName(QString::fromUtf8("robustCheckBox"));
        robustCheckBox->setEnabled(false);
        robustCheckBox->setChecked(true);

        horizontalLayout_3->addWidget(robustCheckBox);


        formLayout->setWidget(2, QFormLayout::FieldRole, signedDistFrame);
        ...
        compute2DCheckBox = new QCheckBox(generalParamsTab);
        compute2DCheckBox->setObjectName(QString::fromUtf8("compute2DCheckBox"));
        compute2DCheckBox->setEnabled(false);

        verticalLayout_7->addWidget(compute2DCheckBox);
        ...
        QObject::connect(signedDistCheckBox, SIGNAL(toggled(bool)), robustCheckBox, SLOT(setEnabled(bool)));

        preciseResultsTabWidget->setCurrentIndex(2);
...
#if QT_CONFIG(tooltip)
        robustCheckBox->setToolTip(QCoreApplication::translate("ComparisonDialog", "Reduces occurences of edge cases where the sign can be inverted.\n"
"Uncheck to reproduce the old behavior.", nullptr));
#endif // QT_CONFIG(tooltip)
        robustCheckBox->setText(QCoreApplication::translate("ComparisonDialog", "robust", nullptr));
#if QT_CONFIG(tooltip)
        ...
        compute2DCheckBox->setText(QCoreApplication::translate("ComparisonDialog", "merge X and Y (compute distance in the xy plane)", nullptr));
#if QT_CONFIG(tooltip)
