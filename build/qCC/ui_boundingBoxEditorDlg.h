...
public:
    ...
    void setupUi(QDialog *BoundingBoxEditorDialog)
    {
        ...
        BoundingBoxEditorDialog->resize(600, 650);
        verticalLayout = new QVBoxLayout(BoundingBoxEditorDialog);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        rasterGridImageLabel = new QLabel(BoundingBoxEditorDialog);
        rasterGridImageLabel->setObjectName(QString::fromUtf8("rasterGridImageLabel"));
        rasterGridImageLabel->setMinimumSize(QSize(0, 270));
        rasterGridImageLabel->setPixmap(QPixmap(QString::fromUtf8(":/CC/images/raster_grid.jpg")));
        rasterGridImageLabel->setAlignment(Qt::AlignCenter);

        verticalLayout->addWidget(rasterGridImageLabel);

        gridFrame = new QFrame(BoundingBoxEditorDialog);
        gridFrame->setObjectName(QString::fromUtf8("gridFrame"));
        gridLayout = new QGridLayout(gridFrame);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        pointTypeComboBox = new QComboBox(gridFrame);
        ...
        widthComboBox = new QComboBox(gridFrame);
        ...
        dxDoubleSpinBox = new QDoubleSpinBox(gridFrame);
        ...
        dyDoubleSpinBox = new QDoubleSpinBox(gridFrame);
        ...
        dzDoubleSpinBox = new QDoubleSpinBox(gridFrame);
