...
public:
    ...
    QGroupBox *upDirGroupBox;
    QHBoxLayout *horizontalLayout_3;
    QDoubleSpinBox *upDirXDoubleSpinBox;
    QDoubleSpinBox *upDirYDoubleSpinBox;
    QDoubleSpinBox *upDirZDoubleSpinBox;
    ...
    void setupUi(QDialog *GeomFeaturesDialog)
    {
        ...
        GeomFeaturesDialog->resize(526, 608);
        ...
        upDirGroupBox = new QGroupBox(roughnessGroupBox);
        upDirGroupBox->setObjectName(QString::fromUtf8("upDirGroupBox"));
        upDirGroupBox->setEnabled(false);
        QSizePolicy sizePolicy(QSizePolicy::Preferred, QSizePolicy::Maximum);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(upDirGroupBox->sizePolicy().hasHeightForWidth());
        upDirGroupBox->setSizePolicy(sizePolicy);
        upDirGroupBox->setCheckable(true);
        upDirGroupBox->setChecked(false);
        horizontalLayout_3 = new QHBoxLayout(upDirGroupBox);
        horizontalLayout_3->setObjectName(QString::fromUtf8("horizontalLayout_3"));
        upDirXDoubleSpinBox = new QDoubleSpinBox(upDirGroupBox);
        upDirXDoubleSpinBox->setObjectName(QString::fromUtf8("upDirXDoubleSpinBox"));
        upDirXDoubleSpinBox->setDecimals(2);
        upDirXDoubleSpinBox->setMinimum(-1.000000000000000);
        upDirXDoubleSpinBox->setMaximum(1.000000000000000);
        upDirXDoubleSpinBox->setSingleStep(0.010000000000000);

        horizontalLayout_3->addWidget(upDirXDoubleSpinBox);

        upDirYDoubleSpinBox = new QDoubleSpinBox(upDirGroupBox);
        upDirYDoubleSpinBox->setObjectName(QString::fromUtf8("upDirYDoubleSpinBox"));
        upDirYDoubleSpinBox->setDecimals(2);
        upDirYDoubleSpinBox->setMinimum(-1.000000000000000);
        upDirYDoubleSpinBox->setMaximum(1.000000000000000);
        upDirYDoubleSpinBox->setSingleStep(0.010000000000000);

        horizontalLayout_3->addWidget(upDirYDoubleSpinBox);

        upDirZDoubleSpinBox = new QDoubleSpinBox(upDirGroupBox);
        upDirZDoubleSpinBox->setObjectName(QString::fromUtf8("upDirZDoubleSpinBox"));
        upDirZDoubleSpinBox->setDecimals(2);
        upDirZDoubleSpinBox->setMinimum(-1.000000000000000);
        upDirZDoubleSpinBox->setMaximum(1.000000000000000);
        upDirZDoubleSpinBox->setSingleStep(0.010000000000000);
        upDirZDoubleSpinBox->setValue(1.000000000000000);

        horizontalLayout_3->addWidget(upDirZDoubleSpinBox);


        verticalLayout_4->addWidget(upDirGroupBox);
        ...
        QObject::connect(roughnessCheckBox, SIGNAL(toggled(bool)), upDirGroupBox, SLOT(setEnabled(bool)));
    ...
    void retranslateUi(QDialog *GeomFeaturesDialog)
    {
        ...
        upDirGroupBox->setToolTip(QCoreApplication::translate("GeomFeaturesDialog", "Defining a 'up direction' allows to compute signed roughness", nullptr));
#endif // QT_CONFIG(tooltip)
        upDirGroupBox->setTitle(QCoreApplication::translate("GeomFeaturesDialog", "Up direction", nullptr));
        upDirXDoubleSpinBox->setPrefix(QCoreApplication::translate("GeomFeaturesDialog", "X=", nullptr));
        upDirYDoubleSpinBox->setPrefix(QCoreApplication::translate("GeomFeaturesDialog", "Y=", nullptr));
        upDirZDoubleSpinBox->setPrefix(QCoreApplication::translate("GeomFeaturesDialog", "Z=", nullptr));
...
#endif // QT_CONFIG(tooltip)
        eigOmnivarianceCheckBox->setText(QCoreApplication::translate("GeomFeaturesDialog", "Omnivariance", nullptr));
#if QT_CONFIG(tooltip)
