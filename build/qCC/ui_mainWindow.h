...
public:
    ...
    QAction *actionRGBGaussianFilter;
    QAction *actionRGBBilateralFilter;
    QAction *actionRGBMeanFilter;
    QAction *actionRGBMedianFilter;
    ...
    QAction *actionSplitCloudUsingSF;
    QAction *actionAddClassificationSF;
    QAction *actionRestoreWindowOnStartup;
    QAction *actionShiftPointsAlongNormals;
    QAction *actionFitCircle;
    QAction *actionSetSFsAsNormal;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionDisplaySettings = new QAction(MainWindow);
        ...
        actionDisplaySettings->setIcon(icon4);
        ...
        actionRGBGaussianFilter = new QAction(MainWindow);
        actionRGBGaussianFilter->setObjectName(QString::fromUtf8("actionRGBGaussianFilter"));
        actionRGBGaussianFilter->setIcon(icon23);
        actionRGBBilateralFilter = new QAction(MainWindow);
        actionRGBBilateralFilter->setObjectName(QString::fromUtf8("actionRGBBilateralFilter"));
        QIcon icon26;
        icon26.addFile(QString::fromUtf8(":/CC/images/ccBilateralFilter.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionRGBBilateralFilter->setIcon(icon26);
        actionRGBMeanFilter = new QAction(MainWindow);
        actionRGBMeanFilter->setObjectName(QString::fromUtf8("actionRGBMeanFilter"));
        actionRGBMedianFilter = new QAction(MainWindow);
        actionRGBMedianFilter->setObjectName(QString::fromUtf8("actionRGBMedianFilter"));
        ...
        QIcon icon27;
        icon27.addFile(QString::fromUtf8(":/CC/images/ccGradient.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionSFGradient->setIcon(icon27);
        actionZoomAndCenter = new QAction(MainWindow);
        actionZoomAndCenter->setObjectName(QString::fromUtf8("actionZoomAndCenter"));
        QIcon icon28;
        icon28.addFile(QString::fromUtf8(":/CC/images/search.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionZoomAndCenter->setIcon(icon28);
        actionSetViewTop = new QAction(MainWindow);
        actionSetViewTop->setObjectName(QString::fromUtf8("actionSetViewTop"));
        QIcon icon29;
        icon29.addFile(QString::fromUtf8(":/CC/images/ccViewZpos.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionSetViewTop->setIcon(icon29);
        ...
        QIcon icon30;
        icon30.addFile(QString::fromUtf8(":/CC/images/ccViewYpos.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionSetViewFront->setIcon(icon30);
#if QT_CONFIG(shortcut)
        ...
        QIcon icon31;
        icon31.addFile(QString::fromUtf8(":/CC/images/ccViewYneg.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionSetViewBack->setIcon(icon31);
#if QT_CONFIG(shortcut)
        ...
        QIcon icon32;
        icon32.addFile(QString::fromUtf8(":/CC/images/ccViewXpos.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionSetViewLeft->setIcon(icon32);
#if QT_CONFIG(shortcut)
        ...
        QIcon icon33;
        icon33.addFile(QString::fromUtf8(":/CC/images/ccViewXneg.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionSetViewRight->setIcon(icon33);
#if QT_CONFIG(shortcut)
        ...
        QIcon icon34;
        icon34.addFile(QString::fromUtf8(":/CC/images/ccViewZneg.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionSetViewBottom->setIcon(icon34);
#if QT_CONFIG(shortcut)
        ...
        QIcon icon35;
        icon35.addFile(QString::fromUtf8(":/CC/images/ccGlobalZoom.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionGlobalZoom->setIcon(icon35);
        ...
        QIcon icon36;
        icon36.addFile(QString::fromUtf8(":/CC/images/ccCenteredPerspective32.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionToggleCenteredPerspective->setIcon(icon36);
        ...
        QIcon icon37;
        icon37.addFile(QString::fromUtf8(":/CC/images/ccViewerBasedPerspective32.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionToggleViewerBasedPerspective->setIcon(icon37);
        actionToggleViewerBasedPerspective->setShortcutContext(Qt::ApplicationShortcut);
        actionRefresh = new QAction(MainWindow);
        actionRefresh->setObjectName(QString::fromUtf8("actionRefresh"));
        QIcon icon38;
        icon38.addFile(QString::fromUtf8(":/CC/images/smallReset.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionRefresh->setIcon(icon38);
        ...
        QIcon icon39;
        icon39.addFile(QString::fromUtf8(":/CC/images/ccGrid.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionRasterize->setIcon(icon39);
        ...
        QIcon icon40;
        icon40.addFile(QString::fromUtf8(":/CC/images/ccSampleCloud.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionSubsample->setIcon(icon40);
        ...
        QIcon icon41;
        icon41.addFile(QString::fromUtf8(":/CC/images/ccPointPicking.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionPointPicking->setIcon(icon41);
        ...
        QIcon icon42;
        icon42.addFile(QString::fromUtf8(":/CC/images/photo-camera.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionEditCamera->setIcon(icon42);
        ...
        QIcon icon43;
        icon43.addFile(QString::fromUtf8(":/CC/images/ccPointListPicking.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionPointListPicking->setIcon(icon43);
        ...
        QIcon icon44;
        icon44.addFile(QString::fromUtf8(":/CC/images/dbViewportSymbol.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionSaveViewportAsObject->setIcon(icon44);
        ...
        QIcon icon45;
        icon45.addFile(QString::fromUtf8(":/CC/images/ccPickCenter.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionPickRotationCenter->setIcon(icon45);
        ...
        actionBilateralFilter->setIcon(icon26);
        ...
        actionSetCenteredPerspectiveView->setIcon(icon36);
        ...
        actionSetViewerPerspectiveView->setIcon(icon37);
        ...
        actionViewFromSensor->setIcon(icon44);
        ...
        actionResetAllVBOs->setObjectName(QString::fromUtf8("actionResetAllVBOs"));
        actionCreateSinglePointCloud = new QAction(MainWindow);
        actionCreateSinglePointCloud->setObjectName(QString::fromUtf8("actionCreateSinglePointCloud"));
        actionPasteCloudFromClipboard = new QAction(MainWindow);
        actionPasteCloudFromClipboard->setObjectName(QString::fromUtf8("actionPasteCloudFromClipboard"));
        actionSplitCloudUsingSF = new QAction(MainWindow);
        actionSplitCloudUsingSF->setObjectName(QString::fromUtf8("actionSplitCloudUsingSF"));
        actionAddClassificationSF = new QAction(MainWindow);
        actionAddClassificationSF->setObjectName(QString::fromUtf8("actionAddClassificationSF"));
        actionAddClassificationSF->setIcon(icon47);
        actionRestoreWindowOnStartup = new QAction(MainWindow);
        actionRestoreWindowOnStartup->setObjectName(QString::fromUtf8("actionRestoreWindowOnStartup"));
        actionRestoreWindowOnStartup->setCheckable(true);
        actionRestoreWindowOnStartup->setChecked(true);
        actionShiftPointsAlongNormals = new QAction(MainWindow);
        actionShiftPointsAlongNormals->setObjectName(QString::fromUtf8("actionShiftPointsAlongNormals"));
        actionFitCircle = new QAction(MainWindow);
        actionFitCircle->setObjectName(QString::fromUtf8("actionFitCircle"));
        actionSetSFsAsNormal = new QAction(MainWindow);
        actionSetSFsAsNormal->setObjectName(QString::fromUtf8("actionSetSFsAsNormal"));
        ...
        QIcon icon64;
        icon64.addFile(QString::fromUtf8(":/CC/images/ccSaveProject.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionSaveProject->setIcon(icon64);
        ...
        QIcon icon65;
        icon65.addFile(QString::fromUtf8(":/CC/images/ccSunLight.png"), QSize(), QIcon::Normal, QIcon::Off);
        menuLights->setIcon(icon65);
        ...
        QIcon icon66;
        icon66.addFile(QString::fromUtf8(":/CC/images/dbGBLSensorSymbol.png"), QSize(), QIcon::Normal, QIcon::Off);
        menuGroundBasedLidar->setIcon(icon66);
        menuCameraSensor = new QMenu(menuSensors);
        menuCameraSensor->setObjectName(QString::fromUtf8("menuCameraSensor"));
        QIcon icon67;
        icon67.addFile(QString::fromUtf8(":/CC/images/dbCamSensorSymbol.png"), QSize(), QIcon::Normal, QIcon::Off);
        menuCameraSensor->setIcon(icon67);
...
"}"));
        ...
        menuDisplay->addAction(actionDisplaySettings);
        ...
        menuDisplay->addAction(actionRestoreWindowOnStartup);
        ...
        menuScalarFields->addAction(actionAddClassificationSF);
        ...
        menuScalarFields->addAction(actionSetSFsAsNormal);
        menuScalarFields->addAction(actionInterpolateSFs);
        menuScalarFields->addAction(actionSplitCloudUsingSF);
        ...
        menuColors->addAction(actionRGBBilateralFilter);
        menuColors->addAction(actionRGBGaussianFilter);
        menuColors->addAction(actionRGBMeanFilter);
        menuColors->addAction(actionRGBMedianFilter);
        ...
        menuNormals->addAction(actionSetSFsAsNormal);
        menuNormals->addSeparator();
        menuNormals->addAction(actionShiftPointsAlongNormals);
        menuNormals->addSeparator();
        ...
        menuFit->addAction(actionFitCircle);
        ...
        toolBarView->addAction(actionDisplaySettings);
        ...
        toolBarMainTools->addAction(actionSaveProject);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionOpen->setToolTip(QCoreApplication::translate("MainWindow", "Open one or severa files", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        actionOpen->setStatusTip(QCoreApplication::translate("MainWindow", "Open one or severa files", nullptr));
...
#if QT_CONFIG(tooltip)
        actionSave->setToolTip(QCoreApplication::translate("MainWindow", "Save current entity", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
...
#endif // QT_CONFIG(shortcut)
        actionDisplaySettings->setText(QCoreApplication::translate("MainWindow", "Display settings", nullptr));
...
#endif // QT_CONFIG(statustip)
        actionRGBGaussianFilter->setText(QCoreApplication::translate("MainWindow", "Gaussian filter", nullptr));
#if QT_CONFIG(tooltip)
        actionRGBGaussianFilter->setToolTip(QCoreApplication::translate("MainWindow", "Compute gaussian filter", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        actionRGBGaussianFilter->setStatusTip(QCoreApplication::translate("MainWindow", "Compute gaussian filter", nullptr));
#endif // QT_CONFIG(statustip)
        actionRGBBilateralFilter->setText(QCoreApplication::translate("MainWindow", "Bilateral filter", nullptr));
#if QT_CONFIG(tooltip)
        actionRGBBilateralFilter->setToolTip(QCoreApplication::translate("MainWindow", "Compute bilateral filter", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        actionRGBBilateralFilter->setStatusTip(QCoreApplication::translate("MainWindow", "Compute bilateral filter", nullptr));
#endif // QT_CONFIG(statustip)
        actionRGBMeanFilter->setText(QCoreApplication::translate("MainWindow", "Mean filter", nullptr));
#if QT_CONFIG(tooltip)
        actionRGBMeanFilter->setToolTip(QCoreApplication::translate("MainWindow", "Compute mean filter", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        actionRGBMeanFilter->setStatusTip(QCoreApplication::translate("MainWindow", "Compute mean filter", nullptr));
#endif // QT_CONFIG(statustip)
        actionRGBMedianFilter->setText(QCoreApplication::translate("MainWindow", "Median filter", nullptr));
#if QT_CONFIG(tooltip)
        actionRGBMedianFilter->setToolTip(QCoreApplication::translate("MainWindow", "Compute median filter", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        actionRGBMedianFilter->setStatusTip(QCoreApplication::translate("MainWindow", "Compute median filter", nullptr));
#endif // QT_CONFIG(statustip)
...
"(so that they all move in the same way and at the same time)", nullptr));
        ...
        actionResetAllVBOs->setText(QCoreApplication::translate("MainWindow", "Reset all VBOs", nullptr));
#if QT_CONFIG(tooltip)
        actionResetAllVBOs->setToolTip(QCoreApplication::translate("MainWindow", "Reset all VBOs (unload GPU memory)", nullptr));
#endif // QT_CONFIG(tooltip)
        actionCreateSinglePointCloud->setText(QCoreApplication::translate("MainWindow", "Create single point cloud", nullptr));
#if QT_CONFIG(tooltip)
        actionCreateSinglePointCloud->setToolTip(QCoreApplication::translate("MainWindow", "Create a cloud with a single point", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        actionCreateSinglePointCloud->setStatusTip(QCoreApplication::translate("MainWindow", "Create a cloud with a single point", nullptr));
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(whatsthis)
        actionCreateSinglePointCloud->setWhatsThis(QString());
#endif // QT_CONFIG(whatsthis)
        actionPasteCloudFromClipboard->setText(QCoreApplication::translate("MainWindow", "Paste from clipboard", nullptr));
#if QT_CONFIG(tooltip)
        actionPasteCloudFromClipboard->setToolTip(QCoreApplication::translate("MainWindow", "Paste from ASCII/text data stored in the clipboard", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        actionPasteCloudFromClipboard->setStatusTip(QCoreApplication::translate("MainWindow", "Paste from ASCII/text data stored in the clipboard", nullptr));
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(shortcut)
        actionPasteCloudFromClipboard->setShortcut(QCoreApplication::translate("MainWindow", "Alt+P", nullptr));
#endif // QT_CONFIG(shortcut)
        actionSplitCloudUsingSF->setText(QCoreApplication::translate("MainWindow", "Split cloud (integer values)", nullptr));
#if QT_CONFIG(tooltip)
        actionSplitCloudUsingSF->setToolTip(QCoreApplication::translate("MainWindow", "Split the selected cloud using the current scalar field.\n"
"The active scalar field should have integer values.", nullptr));
#endif // QT_CONFIG(tooltip)
        actionAddClassificationSF->setText(QCoreApplication::translate("MainWindow", "Add classification SF", nullptr));
#if QT_CONFIG(tooltip)
        actionAddClassificationSF->setToolTip(QCoreApplication::translate("MainWindow", "Add classification SF (shorcut to 'Add constant SF')", nullptr));
#endif // QT_CONFIG(tooltip)
        actionRestoreWindowOnStartup->setText(QCoreApplication::translate("MainWindow", "Restore window geometry on startup", nullptr));
        actionShiftPointsAlongNormals->setText(QCoreApplication::translate("MainWindow", "Shift points along normals", nullptr));
#if QT_CONFIG(tooltip)
        actionShiftPointsAlongNormals->setToolTip(QCoreApplication::translate("MainWindow", "Shift the points of the selected cloud along their normals", nullptr));
#endif // QT_CONFIG(tooltip)
        actionFitCircle->setText(QCoreApplication::translate("MainWindow", "Circle", nullptr));
#if QT_CONFIG(tooltip)
        actionFitCircle->setToolTip(QCoreApplication::translate("MainWindow", "Fits a circle on the selected cloud", nullptr));
#endif // QT_CONFIG(tooltip)
        actionSetSFsAsNormal->setText(QCoreApplication::translate("MainWindow", "Set SF(s) as normal", nullptr));
        ...
        actionSaveProject->setIconText(QCoreApplication::translate("MainWindow", "Save project (BIN)", nullptr));
#if QT_CONFIG(tooltip)
        actionSaveProject->setToolTip(QCoreApplication::translate("MainWindow", "Save all entities in a BIN file", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        actionSaveProject->setStatusTip(QCoreApplication::translate("MainWindow", "Save all entities in a BIN file", nullptr));
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(shortcut)
        actionSaveProject->setShortcut(QCoreApplication::translate("MainWindow", "Ctrl+Shift+S", nullptr));
#endif // QT_CONFIG(shortcut)
        ...
        menuCloud->setTitle(QCoreApplication::translate("MainWindow", "Cloud", nullptr));
