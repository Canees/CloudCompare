...
public:
    ...
    void setupUi(QDialog *PrimitiveFactoryDlg)
    {
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/CC/images/clipboard.png"), QSize(), QIcon::Normal, QIcon::Off);
        spherePosFromClipboardButton->setIcon(icon2);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/CC/images/primSphere.gif"), QSize(), QIcon::Normal, QIcon::Off);
        tabWidget->addTab(sphereTab, icon3, QString());
        cylTab = new QWidget();
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/CC/images/primCylinder.gif"), QSize(), QIcon::Normal, QIcon::Off);
        tabWidget->addTab(cylTab, icon4, QString());
        coneTab = new QWidget();
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/CC/images/primCone.gif"), QSize(), QIcon::Normal, QIcon::Off);
        tabWidget->addTab(coneTab, icon5, QString());
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/CC/images/primTorus.gif"), QSize(), QIcon::Normal, QIcon::Off);
        tabWidget->addTab(torusTab, icon6, QString());
        dishTab = new QWidget();
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/CC/images/primDish.gif"), QSize(), QIcon::Normal, QIcon::Off);
        tabWidget->addTab(dishTab, icon7, QString());
...
#if QT_CONFIG(tooltip)
        spherePosFromClipboardButton->setToolTip(QCoreApplication::translate("PrimitiveFactoryDlg", "Paste from clipboard (3 values expected, separated by a comma, a semicolon or whitespaces)", nullptr));
#endif // QT_CONFIG(tooltip)
