...
public:
    ...
    {
        SFEditDlg->setWindowTitle(QCoreApplication::translate("SFEditDlg", "SF Values", nullptr));
        dispLabel->setText(QCoreApplication::translate("SFEditDlg", "displayed", nullptr));
        satLabel->setText(QCoreApplication::translate("SFEditDlg", "saturation", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab), QCoreApplication::translate("SFEditDlg", "Display ranges", nullptr));
#if QT_CONFIG(tooltip)
        nanInGreyCheckBox->setToolTip(QCoreApplication::translate("SFEditDlg", "hidden otherwise...", nullptr));
#endif // QT_CONFIG(tooltip)
        nanInGreyCheckBox->setText(QCoreApplication::translate("SFEditDlg", "show NaN/out of range values in grey", nullptr));
        alwaysShow0CheckBox->setText(QCoreApplication::translate("SFEditDlg", "always show 0 in color scale", nullptr));
        symmetricalScaleCheckBox->setText(QCoreApplication::translate("SFEditDlg", "symmetrical color scale", nullptr));
        logScaleCheckBox->setText(QCoreApplication::translate("SFEditDlg", "log scale", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QCoreApplication::translate("SFEditDlg", "Parameters", nullptr));
    } // retranslateUi
