...
void ccPropertiesTreeDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ccPropertiesTreeDelegate *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (ccPropertiesTreeDelegate::*)(ccHObject * ) const;
...
QT_INIT_METAOBJECT const QMetaObject ccPropertiesTreeDelegate::staticMetaObject = { {
    QMetaObject::SuperData::link<QStyledItemDelegate::staticMetaObject>(),
    qt_meta_stringdata_ccPropertiesTreeDelegate.data,
    qt_meta_data_ccPropertiesTreeDelegate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
