...
QT_MOC_LITERAL(2, 29, 0) // ""
    ...
    "sfEditDlg\0entitySFHasChanged\0"
};
...
void sfEditDlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<sfEditDlg *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject sfEditDlg::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_sfEditDlg.data,
    qt_meta_data_sfEditDlg,
    qt_static_metacall,
    nullptr,
    nullptr
} };
