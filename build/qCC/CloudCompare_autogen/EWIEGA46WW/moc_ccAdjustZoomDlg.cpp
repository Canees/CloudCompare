...
QT_MOC_LITERAL(1, 16, 14), // "onFocalChanged"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 18), // "onPixelSizeChanged"
QT_MOC_LITERAL(4, 51, 19) // "onPixelCountChanged"

    },
    "ccAdjustZoomDlg\0onFocalChanged\0\0"
...
void ccAdjustZoomDlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ccAdjustZoomDlg *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->onFocalChanged((*reinterpret_cast< double(*)>(_a[1]))); break;
...
QT_INIT_METAOBJECT const QMetaObject ccAdjustZoomDlg::staticMetaObject = { {
    ...
    qt_meta_stringdata_ccAdjustZoomDlg.data,
    qt_meta_data_ccAdjustZoomDlg,
    qt_static_metacall,
    nullptr,
    nullptr
} };
