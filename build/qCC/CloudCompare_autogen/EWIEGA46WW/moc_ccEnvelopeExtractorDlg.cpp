...
QT_INIT_METAOBJECT const QMetaObject ccEnvelopeExtractorDlg::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_ccEnvelopeExtractorDlg.data,
    qt_meta_data_ccEnvelopeExtractorDlg,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ccEnvelopeExtractorDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::EnvelopeExtractorDlg"))
        return static_cast< Ui::EnvelopeExtractorDlg*>(this);
