...
void ccPointPropertiesDlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ccPointPropertiesDlg *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (ccPointPropertiesDlg::*)(ccHObject * );
...
QT_INIT_METAOBJECT const QMetaObject ccPointPropertiesDlg::staticMetaObject = { {
    QMetaObject::SuperData::link<ccPointPickingGenericInterface::staticMetaObject>(),
    qt_meta_stringdata_ccPointPropertiesDlg.data,
    qt_meta_data_ccPointPropertiesDlg,
    qt_static_metacall,
    nullptr,
    nullptr
} };
