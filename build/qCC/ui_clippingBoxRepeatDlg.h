...
"color: white;"));
    ...
    {
        ClippingBoxRepeatDlg->setWindowTitle(QCoreApplication::translate("ClippingBoxRepeatDlg", "Slice extraction", nullptr));
...
#if QT_CONFIG(tooltip)
        envelopeTypeComboBox->setToolTip(QCoreApplication::translate("ClippingBoxRepeatDlg", "Envelope type (lower or upper part, or both)", nullptr));
#endif // QT_CONFIG(tooltip)
        label_2->setText(QCoreApplication::translate("ClippingBoxRepeatDlg", "Max edge length", nullptr));
#if QT_CONFIG(tooltip)
        maxEnvelopeEdgeLengthDoubleSpinBox->setToolTip(QCoreApplication::translate("ClippingBoxRepeatDlg", "Max edge length (if 0, generates a unique and closed envelope = convex hull)", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        lsGridStepDoubleSpinBox->setToolTip(QCoreApplication::translate("ClippingBoxRepeatDlg", "Step of the internally generated grid obtained by rasterizing the points and exporting the contours", nullptr));
#endif // QT_CONFIG(tooltip)
        label_11->setText(QCoreApplication::translate("ClippingBoxRepeatDlg", "Min. vertex count", nullptr));
#if QT_CONFIG(tooltip)
        minLSVertexCountSpinBox->setToolTip(QCoreApplication::translate("ClippingBoxRepeatDlg", "Min vertex count per contour (to ignore the smallest ones)", nullptr));
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        groupByTypeComboBox->setToolTip(QCoreApplication::translate("ClippingBoxRepeatDlg", "How generated slices, envelopes and contours will be regrouped in the DB tree", nullptr));
#endif // QT_CONFIG(tooltip)
    } // retranslateUi
