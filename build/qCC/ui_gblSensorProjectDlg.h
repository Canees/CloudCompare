...
public:
    ...
    void setupUi(QDialog *GBLSensorProjectDialog)
    {
        ...
        yawStepSpinBox->setValue(0.050000000000000);
        ...
        pitchStepSpinBox->setValue(0.050000000000000);
        ...
        QWidget::setTabOrder(rotationOrderComboBox, propertiesTabWidget);
        ...
        QWidget::setTabOrder(x1rot, x2rot);
        QWidget::setTabOrder(x2rot, x3rot);
        QWidget::setTabOrder(x3rot, y1rot);
        QWidget::setTabOrder(y1rot, y2rot);
        QWidget::setTabOrder(y2rot, y3rot);
        QWidget::setTabOrder(y3rot, z1rot);
        QWidget::setTabOrder(z1rot, z2rot);
        QWidget::setTabOrder(z2rot, z3rot);
        QWidget::setTabOrder(z3rot, yawStepSpinBox);
        QWidget::setTabOrder(yawStepSpinBox, pitchStepSpinBox);
        QWidget::setTabOrder(pitchStepSpinBox, uncertaintyDoubleSpinBox);
        QWidget::setTabOrder(uncertaintyDoubleSpinBox, maxRangeDoubleSpinBox);
