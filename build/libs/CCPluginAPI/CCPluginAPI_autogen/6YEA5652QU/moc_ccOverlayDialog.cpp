...
#include <memory>
#include "../../../../../libs/CCPluginAPI/include/ccOverlayDialog.h"
...
QT_MOC_LITERAL(6, 64, 5) // "shown"
    ...
    "accepted\0shortcutTriggered\0key\0shown"
};
...
void ccOverlayDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ccOverlayDialog *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ccOverlayDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_ccOverlayDialog.data,
    qt_meta_data_ccOverlayDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
