...
public:
    ...
    void setupUi(QDialog *ColorScaleEditorDlg)
    {
        ...
        label_5 = new QLabel(customLabelsGroupBox);
    ...
    void retranslateUi(QDialog *ColorScaleEditorDlg)
    {
        ...
        label_5->setText(QCoreApplication::translate("ColorScaleEditorDlg", "One numerical value per line (+ optionally a text label between double quotes)", nullptr));
