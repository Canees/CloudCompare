...
void ccOctree::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ccOctree *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ccOctree::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_ccOctree.data,
    qt_meta_data_ccOctree,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ccOctree::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "CCCoreLib::DgmOctree"))
        return static_cast< CCCoreLib::DgmOctree*>(this);
