...
public:
    ...
    {
        SaveSHPFileDlg->setWindowTitle(QCoreApplication::translate("SaveSHPFileDlg", "Save SHP file", nullptr));
        groupBox->setTitle(QCoreApplication::translate("SaveSHPFileDlg", "3D polylines", nullptr));
        label->setText(QCoreApplication::translate("SaveSHPFileDlg", "Vertical dimension", nullptr));

#if QT_CONFIG(tooltip)
        save3DPolyAs2DCheckBox->setToolTip(QCoreApplication::translate("SaveSHPFileDlg", "Save the 3D polylines as 2D ones (make sure to set the right 'vertical dimension')", nullptr));
#endif // QT_CONFIG(tooltip)
        save3DPolyAs2DCheckBox->setText(QCoreApplication::translate("SaveSHPFileDlg", "save as 2D polylines", nullptr));
#if QT_CONFIG(tooltip)
        save3DPolyHeightInDBFCheckBox->setToolTip(QCoreApplication::translate("SaveSHPFileDlg", "The height of each polyline (considered as constant!) will be saved as a field in the associated DBF file", nullptr));
#endif // QT_CONFIG(tooltip)
        save3DPolyHeightInDBFCheckBox->setText(QCoreApplication::translate("SaveSHPFileDlg", "save (constant) height of polylines as a DBF field", nullptr));
    } // retranslateUi
