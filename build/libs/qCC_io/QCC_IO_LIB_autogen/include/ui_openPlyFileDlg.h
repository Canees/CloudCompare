...
public:
    ...
    QListWidget *scalarFields;
    QHBoxLayout *horizontalLayout;
    QToolButton *addSFToolButton;
    QToolButton *addAllSFToolButton;
    ...
    void setupUi(QDialog *PlyOpenDlg)
    {
        ...
        groupBox = new QGroupBox(PlyOpenDlg);
        groupBox->setObjectName(QString::fromUtf8("groupBox"));
        verticalLayout_2 = new QVBoxLayout(groupBox);
        verticalLayout_2->setObjectName(QString::fromUtf8("verticalLayout_2"));
        scalarFields = new QListWidget(groupBox);
        scalarFields->setObjectName(QString::fromUtf8("scalarFields"));

        verticalLayout_2->addWidget(scalarFields);

        horizontalLayout = new QHBoxLayout();
        horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
        addSFToolButton = new QToolButton(groupBox);
        addSFToolButton->setObjectName(QString::fromUtf8("addSFToolButton"));

        horizontalLayout->addWidget(addSFToolButton);

        addAllSFToolButton = new QToolButton(groupBox);
        addAllSFToolButton->setObjectName(QString::fromUtf8("addAllSFToolButton"));

        horizontalLayout->addWidget(addAllSFToolButton);
    ...
    void retranslateUi(QDialog *PlyOpenDlg)
    {
        ...
        groupBox->setTitle(QCoreApplication::translate("PlyOpenDlg", "Scalar fields", nullptr));
#if QT_CONFIG(tooltip)
        addSFToolButton->setToolTip(QCoreApplication::translate("PlyOpenDlg", "Add a single standard property to be loaded as a Scalar Field", nullptr));
#endif // QT_CONFIG(tooltip)
        addSFToolButton->setText(QCoreApplication::translate("PlyOpenDlg", "Add", nullptr));
#if QT_CONFIG(tooltip)
        addAllSFToolButton->setToolTip(QCoreApplication::translate("PlyOpenDlg", "Add all unused standard properties to be loaded as Scalar Fields", nullptr));
#endif // QT_CONFIG(tooltip)
        addAllSFToolButton->setText(QCoreApplication::translate("PlyOpenDlg", "Add all", nullptr));
