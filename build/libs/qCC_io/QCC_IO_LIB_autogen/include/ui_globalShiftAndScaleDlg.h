...
public:
    ...
    void setupUi(QDialog *GlobalShiftAndScaleDlg)
    {
        ...
        GlobalShiftAndScaleDlg->resize(734, 456);
        ...
        moreInfoToolButton->setText(QString::fromUtf8("?"));
        ...
        xOriginLabel->setText(QString::fromUtf8("x = 3213132123.3215"));
        ...
        yOriginLabel->setText(QString::fromUtf8("y = 3213213143.34"));
        ...
        zOriginLabel->setText(QString::fromUtf8("z = 3.87"));
        ...
        scaleSpinBox->setMinimum(0.000001000000000);
        scaleSpinBox->setMaximum(1000000.000000000000000);
        ...
        label_3->setText(QString::fromUtf8("x"));
        ...
        shiftX->setMinimum(-1000000000000.000000000000000);
        shiftX->setMaximum(1000000000000.000000000000000);
        ...
        shiftY->setMinimum(-1000000000000.000000000000000);
        shiftY->setMaximum(1000000000000.000000000000000);
        ...
        shiftZ->setMinimum(-1000000000000.000000000000000);
        shiftZ->setMaximum(1000000000000.000000000000000);
        ...
        smallCubeFrame->setMinimumSize(QSize(150, 180));
        ...
        xDestLabel->setText(QString::fromUtf8("x = 123.3215"));
        ...
        yDestLabel->setText(QString::fromUtf8("y = 143.34"));
        ...
        zDestLabel->setText(QString::fromUtf8("z = 3.87"));
        ...
        preserveShiftOnSaveCheckBox->setObjectName(QString::fromUtf8("preserveShiftOnSaveCheckBox"));
    ...
    {
        GlobalShiftAndScaleDlg->setWindowTitle(QCoreApplication::translate("GlobalShiftAndScaleDlg", "Global shift/scale", nullptr));
        messageLabel->setText(QCoreApplication::translate("GlobalShiftAndScaleDlg", "Coordinates are too big (original precision may be lost)!", nullptr));
#if QT_CONFIG(tooltip)
        moreInfoToolButton->setToolTip(QCoreApplication::translate("GlobalShiftAndScaleDlg", "More information about this issue", nullptr));
#endif // QT_CONFIG(tooltip)
        label_4->setText(QCoreApplication::translate("GlobalShiftAndScaleDlg", "Do you wish to translate/rescale the entity?", nullptr));
        infoLabel->setText(QCoreApplication::translate("GlobalShiftAndScaleDlg", "shift/scale information is stored and used to restore the original coordinates at export time", nullptr));
#if QT_CONFIG(tooltip)
        bigCubeFrame->setToolTip(QCoreApplication::translate("GlobalShiftAndScaleDlg", "This version corresponds to the input (or output) file", nullptr));
#endif // QT_CONFIG(tooltip)
        label->setText(QCoreApplication::translate("GlobalShiftAndScaleDlg", "Point in original\n"
"coordinate system (on disk)", nullptr));
        diagOriginLabel->setText(QCoreApplication::translate("GlobalShiftAndScaleDlg", "diagonal = 3213132123.3215", nullptr));
        label1->setText(QCoreApplication::translate("GlobalShiftAndScaleDlg", "Shift", nullptr));
        label1_2->setText(QCoreApplication::translate("GlobalShiftAndScaleDlg", "Scale", nullptr));
#if QT_CONFIG(tooltip)
        loadComboBox->setToolTip(QCoreApplication::translate("GlobalShiftAndScaleDlg", "You can add default items to this list by placing a text file named <span style=\" font-weight:600;\">global_shift_list.txt</span> next to the application executable file. On each line you should define 5 items separated by semicolon characters: name ; ShiftX ; ShiftY ; ShiftZ ; scale", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        smallCubeFrame->setToolTip(QCoreApplication::translate("GlobalShiftAndScaleDlg", "This version is the one CloudCompare will work with. Mind the digits!", nullptr));
#endif // QT_CONFIG(tooltip)
        label_2->setText(QCoreApplication::translate("GlobalShiftAndScaleDlg", "Point in local\n"
"coordinate system", nullptr));
        diagDestLabel->setText(QCoreApplication::translate("GlobalShiftAndScaleDlg", "diagonal = 321313", nullptr));
        warningLabel->setText(QCoreApplication::translate("GlobalShiftAndScaleDlg", "Warning: previously used shift and/or scale don't seem adapted to this entity", nullptr));
        preserveShiftOnSaveCheckBox->setText(QCoreApplication::translate("GlobalShiftAndScaleDlg", "Preserve global shift on save", nullptr));
#if QT_CONFIG(tooltip)
        keepGlobalPosCheckBox->setToolTip(QCoreApplication::translate("GlobalShiftAndScaleDlg", "The local coordinates will be changed so as to keep the global coordinates the same", nullptr));
#endif // QT_CONFIG(tooltip)
        keepGlobalPosCheckBox->setText(QCoreApplication::translate("GlobalShiftAndScaleDlg", "Keep original position fixed", nullptr));
    } // retranslateUi
