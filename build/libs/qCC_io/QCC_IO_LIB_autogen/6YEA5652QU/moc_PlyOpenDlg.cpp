...
#include <memory>
#include "../../../../../libs/qCC_io/include/PlyOpenDlg.h"
...
void PlyOpenDlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PlyOpenDlg *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject PlyOpenDlg::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_PlyOpenDlg.data,
    qt_meta_data_PlyOpenDlg,
    qt_static_metacall,
    nullptr,
    nullptr
} };
