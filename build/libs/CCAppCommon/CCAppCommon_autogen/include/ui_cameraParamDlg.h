...
public:
    ...
    QCheckBox *nearClippingCheckBox;
    QDoubleSpinBox *nearClippingDepthDoubleSpinBox;
    QCheckBox *farClippingCheckBox;
    QDoubleSpinBox *farClippingDepthDoubleSpinBox;
    ...
    void setupUi(QDialog *CameraParamDlg)
    {
        ...
        nearClippingCheckBox = new QCheckBox(CameraParamDlg);
        nearClippingCheckBox->setObjectName(QString::fromUtf8("nearClippingCheckBox"));

        formLayout->setWidget(0, QFormLayout::LabelRole, nearClippingCheckBox);

        nearClippingDepthDoubleSpinBox = new QDoubleSpinBox(CameraParamDlg);
        nearClippingDepthDoubleSpinBox->setObjectName(QString::fromUtf8("nearClippingDepthDoubleSpinBox"));
        nearClippingDepthDoubleSpinBox->setEnabled(false);
        nearClippingDepthDoubleSpinBox->setDecimals(6);
        nearClippingDepthDoubleSpinBox->setMaximum(1000000.000000000000000);

        formLayout->setWidget(0, QFormLayout::FieldRole, nearClippingDepthDoubleSpinBox);

        farClippingCheckBox = new QCheckBox(CameraParamDlg);
        farClippingCheckBox->setObjectName(QString::fromUtf8("farClippingCheckBox"));

        formLayout->setWidget(1, QFormLayout::LabelRole, farClippingCheckBox);

        farClippingDepthDoubleSpinBox = new QDoubleSpinBox(CameraParamDlg);
        farClippingDepthDoubleSpinBox->setObjectName(QString::fromUtf8("farClippingDepthDoubleSpinBox"));
        farClippingDepthDoubleSpinBox->setEnabled(false);
        farClippingDepthDoubleSpinBox->setDecimals(6);
        farClippingDepthDoubleSpinBox->setMaximum(1000000.000000000000000);
        farClippingDepthDoubleSpinBox->setValue(1000000.000000000000000);

        formLayout->setWidget(1, QFormLayout::FieldRole, farClippingDepthDoubleSpinBox);
        ...
        QObject::connect(nearClippingCheckBox, SIGNAL(toggled(bool)), nearClippingDepthDoubleSpinBox, SLOT(setEnabled(bool)));
        QObject::connect(farClippingCheckBox, SIGNAL(toggled(bool)), farClippingDepthDoubleSpinBox, SLOT(setEnabled(bool)));
...
#endif // QT_CONFIG(tooltip)
        label_8->setText(QCoreApplication::translate("CameraParamDlg", "Horizontal field of view", nullptr));
#if QT_CONFIG(tooltip)
        fovDoubleSpinBox->setToolTip(QCoreApplication::translate("CameraParamDlg", "Horizontal field of view (in degrees)", nullptr));
#endif // QT_CONFIG(tooltip)
        nearClippingCheckBox->setText(QCoreApplication::translate("CameraParamDlg", "Near clipping depth", nullptr));
        farClippingCheckBox->setText(QCoreApplication::translate("CameraParamDlg", "Far clipping depth", nullptr));
    } // retranslateUi
